...
class sip2 
{
    ...
    public $hostname;
    public $port         = 4117; /* 6002 = default sip2 port for Sirsi */
    public $library      = ''; 
    // ajout de Stanislas le 01/12/2017 :
	// $myIniFile = parse_ini_file ("config.ini", TRUE);
	// public $language = $myIniFile["host"]["language"] ; /* 001= english, 002 = french */
	public $language = '002' ; /* 001= english, 002 = french */
	// fin de l'ajout
    /* Patron ID */
    public $patron       = ''; /* AA */
    public $patronpwd    = ''; /* AD */
